    ...
    if (context.type === context.UserEventType.VIEW) {
      ...
      if (subsidiaryValue == 15) {
        ...
        var newRecord = context.newRecord,
            ...
            form = context.form; // Construct a URL to a Suitelet and open it in a new window when the "Print PR Form" button is clicked
        ...
        }) + "&formtype=" + newType + "&internalId=" + newId + "&l=t', 'printPR', 'height=1056, width=755, resizable=yes, scrollbars=yes, toolbar=no'); printPR.focus();"; // Add a custom button to the form that triggers the "Print PR Form" functionality
