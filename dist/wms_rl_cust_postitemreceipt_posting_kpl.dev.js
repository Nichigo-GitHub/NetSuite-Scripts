                ...
                if (transactionType == "transferorder" && useitemcostflag == true) {
                  ...
                  if (opentaskSearchResults.length > 0 && isMapReduceScriptInvoked == 'F') {
                    ...
                    if (trecord != null && trecord != '') {
                      ...
                      trecord.setValue('memo', 'ST: ' + start_time + ' ET: ' + time_received); // Search for employees with 'entityid' containing 'preparedBy'
                      ...
                      trecord.setValue('custbody1', empSearchResultsvalues[0] ? empSearchResultsvalues[0].id : null); // Search for employees with 'entityid' containing 'inspectedBy'
