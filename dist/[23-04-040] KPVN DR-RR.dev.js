...
define(['N/record', 'N/log', 'N/search'], function (record, log, search) {
  function beforeSubmit(context) {
    ...
    var itemFulfillment = context.newRecord; // Log a message to indicate the script has started
    ...
    if (context.type === context.UserEventType.CREATE && DRcustomform === 459) {
      ...
      var itemFulfillment = context.newRecord; // Retrieve relevant information from the Item Fulfillment (adjust field names as needed)
      ...
      var itemReceiptId = itemReceipt.save(); // Log the Item Receipt ID for reference
