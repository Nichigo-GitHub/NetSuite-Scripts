  ...
  function pageInit(context) {
    ...
    if (context.mode === 'edit') {
      ...
      for (i = 0; i < lineCount; i++) {
        ...
        console.log('i: ' + i + '/' + [lineCount - 1] + ' | PO num: ' + POnum + ' | Item Code: ' + itemCode); // Loop through the search results and add new lines to the sublist
        ...
        if (match == 0) {
          ...
          console.log('---------------------------------'); // Select the line you want to delete
