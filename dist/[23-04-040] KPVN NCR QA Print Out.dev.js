  ...
  if (searchResults) {
    for (var i = 0; i < 1; i++) {
      ...
      for (var j = 1; j <= sublistItemCount; j++) {
        ...
        var part2Match = sublistValue.match(regex2); // Extract the desired parts using match() and the defined regex
