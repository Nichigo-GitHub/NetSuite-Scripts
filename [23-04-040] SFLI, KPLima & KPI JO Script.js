function suitelet(request, response) {
	...
	for (var i = 1; i <= lineCount; i++) {
		...
		if (subsidary == "4") {
			tablerow += addRow1_Indonesia(code, desc, qty + ' ' + unit, '', '');
			//        tablerow2 += addRow2_Indonesia(desc2,'','','','','','','','');
		} else {
			tablerow += addRow1(code, desc, qty + ' ' + unit, excess, '', '', '', '');
		}
	}
	...
	if (subsidary == 14) {
		...
		//24
		twentyfour
			= workorder.getFieldValue('custbody266');
		...
		function NumoneKPL(onetext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>1." + onetext + "</td>" +
		...
		function NumtwoKPL(twotext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>2." + twotext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumthreeKPL(threetext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>3." + threetext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumfourKPL(fourtext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>4." + fourtext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumfiveKPL(fivetext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>5." + fivetext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumsixKPL(sixtext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>6." + sixtext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumsevenKPL(seventext, a, b, c, d, e, f, g, h, i, j) {

			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>7." + seventext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumeightKPL(eighttext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>8." + eighttext + "</td>" +
		...
		function NumnineKPL(ninetext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +

				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>9." + ninetext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtenKPL(tentext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>10." + tentext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>"
				+
		...
		function NumelevenKPL(eleventext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>11." + eleventext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtwelveKPL(twelvetext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>12." + twelvetext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumthirteenKPL(thirteentext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>13." + thirteentext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumfourteenKPL(fourteentext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>14." + fourteentext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumfifteenKPL(fifteentext, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>15." + fifteentext + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumsixteenKPL(sixteen, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>16." + sixteen + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumseventeenKPL(seventeen, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>17." + seventeen + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumeightteenKPL(eightteen, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>18." + eightteen + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumnineteenKPL(nineteen, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>19." + nineteen + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtwentyKPL(twenty, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>20." + twenty + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtwentyoneKPL(twentyone, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>21." + twentyone + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtwentytwoKPL(twentytwo, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>22." + twentytwo + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtwentythreeKPL(twentythree, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>23." + twentythree + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtwentyfourKPL(twentyfour, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>24." + twentyfour + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumtwentyfiveKPL(twentyfive, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>25." + twentyfive + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		function NumextraKPL(twentyfive, a, b, c, d, e, f, g, h, i, j) {
			return row1 = "<tr height='20px'>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + twentyfive + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + a + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + b + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + c + "</td>" +
				"<td class='padding borderRight borderBottom' height='20px' rowspan='2'>" + d + "</td>" +
		...
		threerow = "";
		if (three != "" && three != null) {
			threerow += NumthreeKPL(threetext, '', '', '', '', '', 'G', 'R', '', '', '');
			html = html.replace('{three}', threerow == null ? '' : threerow);
		}
		...
		fourrow = "";
		if (four != "" && four != null) {
			fourrow += NumfourKPL(fourtext, '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{four}', fourrow == null ? '' : fourrow);
		...
		fiverow = "";
		if (five != "" && five != null) {
			fiverow += NumfiveKPL(fivetext, '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{five}', fiverow == null ? '' : fiverow);
		...
		sevenrow = "";
		if (seven != "" && seven != null) {
			sevenrow += NumsevenKPL(seventext, '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{seven}', sevenrow == null ? '' : sevenrow);
		//eight 
		eight = workorder.getFieldValue('custbody233');
		...
		eightrow = "";
		if (eight != "" && eight != null) {
			eightrow += NumeightKPL(eighttext, '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{eight}', eightrow == null ? '' : eightrow);
		//nine 
		nine = workorder.getFieldValue('custbody234');
		...
		ninerow = "";
		if (nine != "" && nine != null) {
			ninerow += NumnineKPL(ninetext, '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{nine}', ninerow == null ? '' : ninerow);
		//ten 
		ten = workorder.getFieldValue('custbody235');
		...
		elevenrow = "";
		if (eleven != "" && eleven != null) {
			elevenrow += NumelevenKPL(eleventext, '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{eleven}', elevenrow == null ? '' : elevenrow);
		//twelve
		twelve = workorder.getFieldValue('custbody242');
		...
		twelverow = "";
		if (twelve != "" && twelve != null) {
			twelverow += NumtwelveKPL(twelvetext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{twelve}', twelverow == null ? '' : twelverow);
		//thirteen
		thirteen = workorder.getFieldValue('custbody243');
		...
		thirteenrow = "";
		if (thirteen != "" && thirteen != null) {
			thirteenrow += NumthirteenKPL(thirteentext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{thirteen}', thirteenrow == null ? '' : thirteenrow);
		//fourteen
		fourteen = workorder.getFieldValue('custbody244');
		...
		fourteenrow = "";
		if (fourteen != "" && fourteen != null) {
			fourteenrow += NumfourteenKPL(fourteentext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{fourteen}', fourteenrow == null ? '' : fourteenrow);
		//fifteen
		fifteen = workorder.getFieldValue('custbody245');
		...
		fifteenrow = "";
		if (fifteen != "" && fifteen != null) {
			fifteenrow += NumfifteenKPL(fifteentext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{fifteen}', fifteenrow == null ? '' : fifteenrow);
		//16
		sixteen = workorder.getFieldValue('custbody258');
		...
		sixteenrow = "";
		if (sixteen != "" && sixteen != null) {
			sixteenrow += NumsixteenKPL(sixteentext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{sixteen}', sixteenrow == null ? '' : sixteenrow);
		//17
		seventeen = workorder.getFieldValue('custbody259');
		...
		seventeenrow = "";
		if (seventeen != "" && seventeen != null) {
			seventeenrow += NumseventeenKPL(seventeentext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{seventeen}', seventeenrow == null ? '' : seventeenrow);
		//18
		eightteen = workorder.getFieldValue('custbody260');
		...
		eightteenrow = "";
		if (eightteen != "" && eightteen != null) {
			eightteenrow += NumeightteenKPL(eightteentext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{eightteen}', eightteenrow == null ? '' : eightteenrow);
		//19
		nineteen = workorder.getFieldValue('custbody261');
		...
		nineteenrow = "";
		if (nineteen != "" && nineteen != null) {
			nineteenrow += NumnineteenKPL(nineteentext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{nineteen}', nineteenrow == null ? '' : nineteenrow);
		//20
		twenty = workorder.getFieldValue('custbody262');
		...
		twentyrow = "";
		if (twenty != "" && twenty != null) {
			twentyrow += NumtwentyKPL(twentytext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{twenty}', twentyrow == null ? '' : twentyrow);
		//21
		twentyone = workorder.getFieldValue('custbody263');
		...
		twentyonerow = "";
		if (twentyone != "" && twentyone != null) {
			twentyonerow += NumtwentyoneKPL(twentyonetext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{twentyone}', twentyonerow == null ? '' : twentyonerow);
		//22
		...
		twentytworow = "";
		if (twentytwo != "" && twentytwo != null) {
			twentytworow += NumtwentytwoKPL(twentytwotext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{twentytwo}', twentytworow == null ? '' : twentytworow);
		//23
		twentythree = workorder.getFieldValue('custbody265');
		...
		twentythreerow = "";
		if (twentythree != "" && twentythree != null) {
			twentythreerow += NumtwentythreeKPL(twentythreetext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{twentythree}', twentythreerow == null ? '' : twentythreerow);
		//24
		twentyfour
		...
		twentyfourrow = "";
		if (twentyfour != "" && twentyfour != null) {
			twentyfourrow += NumtwentyfourKPL(twentyfourtext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{twentyfour}', twentyfourrow == null ? '' : twentyfourrow);
		//25
		twentyfive = workorder.getFieldValue('custbody267');
		...
		twentyfiverow = "";
		if (twentyfive != "" && twentyfive != null) {
			twentyfiverow += NumtwentyfiveKPL(twentyfivetext, '', '', '', '', '', '', 'G', 'R', '', '', '');
		}
		html = html.replace('{twentyfive}', twentyfiverow == null ? '' : twentyfiverow);
		...
		var extra = "";
		var extraText = "";
		extra += NumextraKPL(extraText, '', '', '', '', '', 'G', 'R', '', '', '');
		html = html.replace('{extra}', extra == null ? '' : extra);
		html = html.replace('{extra2}', extra == null ? '' : extra);
		html = html.replace('{extra3}', extra == null ? '' : extra);
	...
	function addRow1(code, desc, qty, excess, a, b, c, d) {
	...
	function addRow1_Indonesia(code, desc, qty, a, b) {
...
function addRow2_Indonesia(desc2) {
	return row2 = "<tr>" +
		"<td class='padding borderRight borderBottom' height='50px'>" + desc2 + "</td>" +
