...
define(['N/record'], function (record) {
    ...
    function generatePDFContent(item, quantity, desc, unit, customer, jonum, line, sublistLength) {
      ...
      var pdfContent =
        ...
        "<td class='title3 border' style='font-size: 27px'>JO NUMBER:</td></tr>" +
        "<tr><td class='border borderWidth' style='height: 45px'></td>" +
        "<td class='border borderWidth field' style='height: 45px'><span style='font-size: 25px;'>" + jonum + "</span></td></tr>" +
        "</table>" +
        "<table>" +
        ...
        "<td class='title5 border borderWidth'>" + quantity + " " + unit + "<br><span style='font-size: 15px; font-weight: bold;'>(note: This is the quantity for adjustment)</span></td></tr>" +
        "</table>" +
        "<table>" +
