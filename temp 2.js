      ...
      try {
        if (utility.isValueValid(requestBody)) {
          ...
          if (!utility.isValueValid(binName)) {
            ...
            log.debug('toBin internal id valid', !utility.isValueValid(toBinInternalId));

            log.debug('right flag', (processType == 'BinTransfer' && toBinInternalLoctype == 'Stage' && fromBinLocationType != null && fromBinLocationType.length == 0));
