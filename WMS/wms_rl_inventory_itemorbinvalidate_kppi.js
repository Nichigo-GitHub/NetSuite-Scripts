 ...
 * @NModuleScope Public
 */
define(['N/search', './wms_utility_kppi', './wms_translator_kppi', './wms_inventory_utility_lima'],
	...
	function (search, utility, translator, invtUtility) {
		...
		function binValidation(requestParams) {
			...
			if (binSearchResults.length > 0) {
				...
				if (processType == 'binTransfer' && binSearchResults[0].getText({
						name: 'custrecord_wmsse_bin_loc_type'
					}) == 'WIP' && binSearchResults[0].getValue({
