...
define(['N/search','N/record','./wms_utility','./big','./wms_translator','./wms_inventory_utility'],
			...
			if (utility.isValueValid(requestBody)) {
				...
				else
				{
					...
					var	 binSearchResults=search.load({
						id : 'customsearch_wmsse_tobin_details_2'
					});
										...
										(blnMixItem == true || blnMixItem == 'true'))
								{
									...
									else
									{
										...
										impactRec = fnBinTransfer(itemType, warehouseLocationId, itemInternalId, binTransferQty, fromBinInternalId, toBinInternalId, lotName, actualBeginTime, stockUnitName,
											stockConversionRate, openTaskQty,fromStatusInternalId, statusInternalId,tallyScanObj,processType);
	...
	function fnBinTransfer(itemType, warehouseLocationId, itemInternalId, binTransferQty, fromBinInternalId, toBinInternalId,
                           lotName, actualBeginTime, stockUnitName, stockConversionRate, openTaskQty,fromStatusInternalId,
                           statusInternalId,tallyScanObj,processType)
	{
		var bintransferObj ={};
		var impactRec = {};
