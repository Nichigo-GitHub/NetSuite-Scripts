 ...
 * @NModuleScope Public
 */
define(['N/search', 'N/record', './wms_utility', './big', './wms_translator', './wms_tallyScan_utility', './wms_outBoundUtility', './wms_inventory_utility.js'],
    /**
     * @param {search} search
     */
        ...
        function doPost(requestBody) {
            ...
            try {
                    if (utility.isValueValid(requestBody)) {
                        log.debug({ title: 'doPost_requestBody', details: requestBody });
            ...
            try {
                log.debug({ title: 'doPost_response', details: qtyValidate });
            } catch (logErr) {
                log.error({ title: 'doPost_response_error', details: logErr });
            }
            return qtyValidate;
        }
