				...
				{	if(utility.isValueValid(transactionName)){
					...
					{ 
						...
						if( checkFlag == 'F'){
							...
							log.debug({title:'woDetailsList',details:woDetailsList});
							...
							{ 
								...
								log.debug({title:'pickQtyResults',details:pickQtyResults});
								...
								if(pickqty == '' || pickqty == null || pickqty == 'null' || pickqty == undefined || isNaN(pickqty))
									pickqty =0;
								log.debug({title:'pickqty',details:pickqty});
								log.debug({title:'vtotalItemRcvQty',details:vtotalItemRcvQty});
								...
								log.debug({title:'checkStageFlag',details:checkStageFlag});
							}
