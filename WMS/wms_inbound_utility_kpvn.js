 ...
 * @NModuleScope public
 */
define(['N/search', 'N/runtime', 'N/record', 'N/format', './big_open', './wms_translator_kpvn', './wms_utility_kpvn', 'N/query', './wms_inboundUtility_kpvn'],
	function (search, runtime, record, format, Big, translator, utility, query, inboundUtility) {
		function consolidatePostItemReceipt(trecord, actQuantity, linenum, itemId, transactionType, batchNo, expiryDate, whLocationId, enterBin, serialArray, opentaskSearchResults, transactionInternalId, itrValue, randomTallyScanRule) {
			try {
