			...
			if(utility.isValueValid(requestBody))
			{
				...
				if(action == 'binSelceted'){
					...
					var binValidateSearch = search.load({
							...
							id : 'customsearch_wms_wo_inv_balance_bintyp_2'});
					...
					{
						var openTaskPickBinDtls = woUtility.getOPenTaskPickBinDetails(itemInternalId, binValidateSearchRes[0]['custrecord_bin_code'], warehouseLocationId);
						...
						{
							binArray['isValid'] = true;
							binArray['binInternalId'] = binValidateSearchRes[0]['custrecord_bin_code'];
