 ...
 * @NModuleScope Public
 */
define(['./wms_utility', './wms_translator', './big', './wms_workOrderUtility_kppi', './wms_tallyScan_utility', 'N/query', 'N/search'],

    function (utility, translator, Big, woUtility, tallyScanUtility, query, search) {
