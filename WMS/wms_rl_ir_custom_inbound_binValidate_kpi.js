 ...
 * @NModuleScope Public
 */
define(["N/search", "N/config", "./wms_utility", "./big", "./wms_translator", "./wms_inboundUtility_kpi", "./wms_inbound_utility_kpi", "N/record", "N/runtime", "N/task"],
  /**
   * @param {search} search
   */
    ...
    function doPost(requestBody) {
      ...
      try {
        if (utility.isValueValid(requestBody)) {
          ...
          declaredQty = requestParams.declaredQty;
              ...
              if (utility.isValueValid(enterBin)) {
                ...
                if (tempflag) {
                  ...
                  if (isTallyScanRequired == true && randomTallyScanRule == "T") {
                    ...
                    postIrObj.declaredQty = declaredQty;
                    var barcodeDataObj = {};
